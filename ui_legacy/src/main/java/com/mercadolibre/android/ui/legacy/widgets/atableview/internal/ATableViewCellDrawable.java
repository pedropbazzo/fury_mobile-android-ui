...
public class ATableViewCellDrawable extends ShapeDrawable {
    ...
    public ATableViewCellDrawable(ATableView tableView, ATableViewCellBackgroundStyle backgroundStyle,
        ...
        if (mTableView.getStyle() == ATableViewStyle.Grouped &&
            ...
            int etchedLineColor = res.getColor(com.mercadolibre.android.ui.legacy.R.color.atv_cell_grouped_etched_line);
            ...
            if (backgroundStyle == ATableViewCellBackgroundStyle.Top ||
                ...
                etchedLineColor = res.getColor(com.mercadolibre.android.ui.legacy.R.color.atv_cell_grouped_top_cell_etched_line);
            }
    ...
    private int getSeparatorColor() {
        ...
        if (color == -1) {
            color = res.getColor(com.mercadolibre.android.ui.legacy.R.color.atv_plain_separator);
            if (mTableView.getStyle() == ATableViewStyle.Grouped) {
                color = res.getColor(com.mercadolibre.android.ui.legacy.R.color.atv_grouped_separator);
            }
        }
        return color;
    }
