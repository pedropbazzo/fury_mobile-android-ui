...
/**
 * Copy of the one in UI to avoid dependency of something that should be eliminated (MLImageView is
 * the only usage for this here. Remove this when MLImageView is removed) THIS ONE HAS PACKAGE ACCESS.
 *
...
class FrescoImageController {
    ...
    public static class Builder {
         ...
         *
         * In favor of Fresco 1.+, consider using {@link #listener(FrescoImageListener)}
         *
         * @param listener from where callbacks will be observed
         * @return Builder
         *
         * @deprecated use {@link #listener(FrescoImageListener)}
         */
        @Deprecated
